...
enum CatalogType: String, CaseIterable, Comparable, Decodable {
    ...
    func url(for seedType: CatalogSeedType) -> String {
        ...
        case .tahoe:
            ...
            case .customer:
                "https://swscan.apple.com/content/catalogs/others/index-26customerseed-26-15-14-13-12-10.16-10.15-" +
                    "10.14-10.13-10.12-10.11-10.10-10.9-" +
                    "mountainlion-lion-snowleopard-leopard.merged-1.sucatalog.gz"
            case .developer:
                "https://swscan.apple.com/content/catalogs/others/index-26seed-26-15-14-13-12-10.16-10.15-10.14-10.13-10.12-10.11-" +
                    "10.10-10.9-mountainlion-lion-snowleopard-leopard.merged-1.sucatalog.gz"
            case .public:
                "https://swscan.apple.com/content/catalogs/others/index-26beta-26-15-14-13-12-10"
                    + ".16-10.15-10.14-10.13-10.12-10.11-10.10-10.9-mountainlion-lion-snowleopard-leopard"
                    + ".merged-1.sucatalog.gz"
            }
        case .sequoia:
            switch seedType {
            case .standard:
                "https://swscan.apple.com/content/catalogs/others/index-15-14-13-12-10.16-10.15-10.14-10.13-10.12-10.11-"
                    + "10.10-10.9-mountainlion-lion-snowleopard-leopard.merged-1.sucatalog.gz"
            case .customer:
                "https://swscan.apple.com/content/catalogs/others/index-15customerseed-15-14-13-12-10.16-10.15-10.14-10.13-10.12-" +
                    "10.11-10.10-10.9-mountainlion-lion-snowleopard-leopard.merged-1.sucatalog.gz"
            case .developer:
                "https://swscan.apple.com/content/catalogs/others/index-15seed-15-14-13-12-10.16-10.15-10.14-10.13-10.12-10.11-"
                    + "10.10-10.9-mountainlion-lion-snowleopard-leopard.merged-1.sucatalog.gz"
            case .public:
                "https://swscan.apple.com/content/catalogs/others/"
                    + "index-15beta-15-14-13-12-10.16-10.15-10.14-10.13-10.12-10.11-"
                    + "10.10-10.9-mountainlion-lion-snowleopard-leopard.merged-1.sucatalog.gz"
            }
        case .sonoma:
            switch seedType {
            ...
            case .customer:
                "https://swscan.apple.com/content/catalogs/others/index-14customerseed-14-13-12-10.16-10.15-10.14-10"
                    + ".13-10.12-10.11-10.10-10.9-mountainlion-lion-snowleopard-leopard.merged-1.sucatalog.gz"
            case .developer:
